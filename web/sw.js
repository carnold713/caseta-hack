...
const VERSION = 'v8';
const SHELL = ['/', '/index.html', '/styles.css', '/light.css', '/manifest.webmanifest', '/vendor/gsap.min.js', '/js/core.js', '/js/pico.js', '/js/home.js', '/js/light.js', '/js/remotes.js', '/js/scenes.js', '/js/settings.js', '/js/boot.js', '/icons/icon-192.png', '/icons/icon-512.png', '/icons/maskable-512.png'];
