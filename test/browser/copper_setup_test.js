...
(async () => {
  ...
  // everything below changes the home, so it is put back however the test ends: a home left in another time zone
  // shows the next test a banner it did not expect
  try {
