...
const ORDER = [
  ...
  'polish_test', 'ia_test', 'v7_light_test', 'v7_scenes_test', 'roomscene_test', 'ui_test2', 'kinds_test', 'height_test', 'hscroll_test', 'swipe_test',
  ...
  'v7_home_test', 'v7_night_test', 'v7_log_test', 'v7_setup_test', 'toastoff_test', 'roomopen_test', 'predictiveback_test', 'chipopen_test', 'lightopen_test', 'remoteopen_test',
  'layout_shell_test', 'shell_nav_test',
];
